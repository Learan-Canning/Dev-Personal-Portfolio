        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-4">
            ...
            <p className="mt-6 text-lg text-muted-foreground max-w-lg animate-fade-in animation-delay-200">
              Hey, I'm Learan Canning. I'm a full-stack Developer building
              real-world web applications across both front-end and back-end.
              I’m passionate about crafting seamless user experiences and
          ...
          <div className="flex items-center gap-4 animate-fade-in animation-delay-400">
            ...
            {[
              ...
              {
                icon: Linkedin,
                href: "https://www.linkedin.com/in/learan-canning/",
              },
              {
                icon: Facebook,
                href: "https://www.facebook.com/profile.php?id=61588159460486&sk=directory_basic_info&locale=en_GB",
              },
            ].map((social, idx) => (
              <a
                key={idx}
          ...
          <div className="relative animate-fade-in animation-delay-300">
            ...
            <div className="w-full max-w-sm mx-auto">
              ...
              <div className="relative glass rounded-3xl p-2 glow-border">
                <img
                  src="/public/profile-photo.webp"
                  alt="Profile Photo, of Learan Canning"
